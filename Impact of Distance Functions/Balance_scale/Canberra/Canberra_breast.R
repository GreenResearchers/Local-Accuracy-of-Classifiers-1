...
dist <- distances("length",new_df, "Euclidean")
write.table(dist, file="C:/Users/Mahin/Google Drive/Workspace/Impact of Distance Functions/Abalone/Canberra/abalone_Canberra_distances.txt", row.names=FALSE, col.names=FALSE)
neighbours <- t(apply(dist, 1, order)[ 1:6, ])
write.table(neighbours, file="C:/Users/Mahin/Google Drive/Workspace/Impact of Distance Functions/Abalone/Canberra/abalone_Canbberra_neighbours.txt", row.names=FALSE, col.names=FALSE)
