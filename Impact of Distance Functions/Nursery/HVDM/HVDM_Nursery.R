...
dist <- distances("health",new_df, "HVDM")
...
write.table(safe, file="C:/Users/Mahin/Google Drive/Workspace/Impact of Distance Functions/Nursery/HVDM/Nursery_HVDM_safe.txt", row.names=FALSE, col.names=FALSE)
write.table(boarderline, file="C:/Users/Mahin/Google Drive/Workspace/Impact of Distance Functions/Nursery/HVDM/Nursery_HVDM_boarderline.txt", row.names=FALSE, col.names=FALSE)
write.table(rare, file="C:/Users/Mahin/Google Drive/Workspace/Impact of Distance Functions/Nursery/HVDM/Nursery_HVDM_rare.txt", row.names=FALSE, col.names=FALSE)
write.table(outlier, file="C:/Users/Mahin/Google Drive/Workspace/Impact of Distance Functions/Nursery/HVDM/Nursery_HVDM_outlier.txt", row.names=FALSE, col.names=FALSE)

x <- data.frame("safe" = c(length(safe)), "boarderline" = c(length(boarderline)),"rare" = c(length(rare)),"outlier" = c(length(outlier)))
write.table(x, file="C:/Users/Mahin/Google Drive/Workspace/Impact of Distance Functions/Nursery/HVDM/Nursery_HVDM_subconcepts.txt", row.names=FALSE, col.names=T,sep=",")
