...
dist <- distances("length",new_df, "Chebyshev")
write.table(dist, file="C:/Users/Mahin/Google Drive/Workspace/Impact of Distance Functions/Abalone/Chebyshev/abalone_Chebyshev_distances.txt", row.names=FALSE, col.names=FALSE)
neighbours <- t(apply(dist, 1, order)[ 1:6, ])
write.table(neighbours, file="C:/Users/Mahin/Google Drive/Workspace/Impact of Distance Functions/Abalone/Chebyshev/abalone_Chebyshev_neighbours.txt", row.names=FALSE, col.names=FALSE)
