...
max_value = df[["l_weight", "l_distance", "r_weight", "r_distance"]].max()
min_value = df[["l_weight", "l_distance", "r_weight", "r_distance"]].min()
std = df[["l_weight", "l_distance", "r_weight", "r_distance"]].std()



range= max_value-min_value
df[["l_weight", "l_distance", "r_weight", "r_distance"]]= \
    ((df[["l_weight", "l_distance", "r_weight", "r_distance"]]-min_value)/std)
