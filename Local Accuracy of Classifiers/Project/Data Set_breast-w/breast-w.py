...
print(df)
#max_value = df[["c_thickness","uni_cel_size","uni_cel_shape","mer_adher","single_epi_cel_size","bare_nuc","bland_cro",
#           "normal_nuec","mitosis"]].max()
#min_value = df[["c_thickness","uni_cel_size","uni_cel_shape","mer_adher","single_epi_cel_size","bare_nuc","bland_cro",
#           "normal_nuec","mitosis"]].min()
...
#df[["c_thickness","uni_cel_size","uni_cel_shape","mer_adher","single_epi_cel_size","bare_nuc","bland_cro",
#           "normal_nuec","mitosis"]]= \
#    ((df[["c_thickness","uni_cel_size","uni_cel_shape","mer_adher","single_epi_cel_size","bare_nuc","bland_cro",
#           "normal_nuec","mitosis"]]-min_value)/std)
