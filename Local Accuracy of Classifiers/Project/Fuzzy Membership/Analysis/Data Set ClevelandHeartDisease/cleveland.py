...
headers = ["a1", "a2", "a3", "a4", "a5","a6", "a7", "a8", "a9","a10","a11","a12","a13","class"]

df = pd.read_csv("cleveland.data", header=None, names=headers, na_values="?")
...
std = df[["a1", "a4", "a5", "a8", "a10"]].std()



nominal_attribute_no=[1,2,5,6,8,10,11,12]
numeric_attribute_no=[0,3,4,7,9]
label_attribute_no=13
minority_label=1
majority_label=0
...
s.write_separetely(safe,borderline,rare,outlier,'C:/Users/Mahin/Google Drive/Workspace/Local Accuracy of Classifiers/Project/Fuzzy Membership/Analysis/Data Set ClevelandHeartDisease/')
