...
df = pd.read_csv("haberman.data", header=None, names=headers, na_values="?")
...
numeric_attribute_no=[0,1,2]
label_attribute_no=3
minority_label=2
majority_label=1
...
s.write_separetely(safe,borderline,rare,outlier,'C:/Users/Mahin/Google Drive/Workspace/Local Accuracy of Classifiers/Project/Fuzzy Membership/Analysis/Data Set Haberman/')
#print(GM_all)
