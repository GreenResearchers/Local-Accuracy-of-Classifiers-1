...
headers = ["a1", "a2", "a3", "a4","a5","a6","a7","a8","a9","class"]

df = pd.read_csv("breastcancer.data", header=None, names=headers, na_values="?")
...
nominal_attribute_no=[0,1,2,3,4,5,6,7,8]
...
safe,borderline,rare,outlier=s.subCategoryAndFuzzyMembershipFinder(distances,majority_label,minority_label,15,X,y)
#s.write(safe,borderline,rare,outlier,str)
s.write_separetely(safe,borderline,rare,outlier,'C:/Users/Mahin/Google Drive/Workspace/Local Accuracy of Classifiers/Project/Fuzzy Membership/Analysis/Data Set BreastCancer/')
